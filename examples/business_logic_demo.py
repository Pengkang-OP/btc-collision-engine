...
def example_1_target_table():
    ...
    # 从WIF列表加载目标地址
    wif_list = [
        "KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYjgd9M7rFU73sVHnoWn",  # 示例WIF
        # 可以添加更多WIF地址
    ]
...
def example_5_match_storage():
    ...
    match_data = {
        ...
        'hash160': secrets.token_bytes(20).hex(),
        'generated': {
            'private_key': secrets.token_bytes(32),
            ...
            'public_key_compressed': secrets.token_bytes(33),
            'public_key_uncompressed': secrets.token_bytes(65),
            'address_compressed': '1BvBMSEYstWetqTFn5Au4m4GFg7xJaNVN2',
            'address_uncompressed': '1EHNa6Q4Jz2uvNExL497mE43ikXhwF6kZm',
            'hash160_compressed': secrets.token_bytes(20),
            'hash160_uncompressed': secrets.token_bytes(20)
        },
        'target': {
