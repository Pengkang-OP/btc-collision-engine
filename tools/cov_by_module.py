...
MODULES = {
    ...
    "utils": [
        ...
        "test_log_throttling.py",
        "test_security_log_filter.py",
        "test_utils.py",
        "test_utils_core.py",
    ...
    "monitoring": [
        ...
        "test_alert_system_integration.py",
        "test_data_logger.py",
        "test_data_logging_integration.py",
        "test_data_monitor.py",
        "test_enhanced_monitoring.py",
        "test_engine_monitoring.py",
        "test_monitor_config.py",
        "test_monitoring_integration.py",
        "test_notification_channels.py",
        "test_optimization_monitor.py",
        "test_event_bus.py",
    ...
    "i18n": ["test_i18n.py"],
    "collision": [
        "test_collision_core.py",
        "test_collision_stats.py",
        "test_key_collision_engine.py",
        "test_match_storage.py",
        "test_address_matching_flow.py",
        "test_checkpoint_manager.py",
        "test_memory_pool.py",
        "test_memory_pool_fix.py",
        "test_memory_locking.py",
    ...
    "core": [
        "test_core_crypto.py",
        "test_core_fixes_verification.py",
        "test_bigint_optimizer.py",
        "test_crypto_backend.py",
        "test_bitcoin_key_validation.py",
        "test_address_generator_base.py",
        "test_key_generator_entropy.py",
        "test_entropy_check.py",
        "test_known_keypair_verification.py",
    ],
    "cli": [
        "test_cli.py",
        "test_cli_integration.py",
        "test_cli_advanced_features.py",
        "test_commands.py",
    ],
}
