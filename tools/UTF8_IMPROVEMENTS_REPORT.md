...
**创建的文件**:
- [tools/utf8_helper.py](file:///f:/Qoder/btc-collision-engine/tools/utf8_helper.py) - UTF-8编码支持共享模块
...
**创建的文件**:
- [tests/test_utf8_helper.py](file:///f:/Qoder/btc-collision-engine/tests/test_utf8_helper.py) - UTF-8辅助功能测试
