...
class TestAddressImport:
    ...
    def test_import_from_text_file(self):
        ...
        try:
            ...
            assert pathlib.Path(result["storage_path"]).exists()
            ...
            if pathlib.Path(temp_txt_path).exists():
    ...
    def test_import_from_json_file(self):
        ...
        try:
            ...
            if pathlib.Path(temp_json_path).exists():
    ...
    def test_import_from_csv_file(self):
        ...
        try:
            ...
            if pathlib.Path(temp_csv_path).exists():
