...
class TestErrorHandling:
    ...
    def test_storage_invalid_path(self):
        ...
        if platform.system() == 'Windows':
            ...
            storage = AddressStorage(storage_type='json', path='C:\\Windows\\System32\\test_btc_data.json')
        else:
            # Unix系统目录
        ...
        try:
            ...
            # 如果没抛异常，检查结果
            assert result is False or os.path.exists('C:\\Windows\\System32\\test_btc_data.json') or os.path.exists('/etc/test_btc_data.json')
