...
class TestGPUDeviceScorerIdentifyModel(unittest.TestCase):
    ...
    def test_01_nvidia_rtx50(self):
        self.assertEqual(self.scorer.identify_model("NVIDIA GeForce RTX 5090", "nvidia"), "rtx50")

    def test_02_nvidia_rtx40(self):
        self.assertEqual(self.scorer.identify_model("NVIDIA GeForce RTX 4090", "nvidia"), "rtx40")
    ...
    def test_06_nvidia_gtx10(self):
        self.assertEqual(self.scorer.identify_model("NVIDIA GeForce GTX 1080", "nvidia"), "gtx10")

    def test_07_nvidia_titan(self):
        self.assertEqual(self.scorer.identify_model("NVIDIA TITAN RTX", "nvidia"), "titan")

    def test_08_nvidia_tesla(self):
        self.assertEqual(self.scorer.identify_model("Tesla V100", "nvidia"), "tesla")
    ...
    def test_11_amd_rx590(self):
        ...
        self.assertEqual(self.scorer.identify_model("Radeon RX 590", "amd"), "rx500")

    def test_12_amd_rx550(self):
        """S5 修复: RX 550 应识别为 rx500"""
        self.assertEqual(self.scorer.identify_model("Radeon RX 550", "amd"), "rx500")

    def test_13_amd_rx480(self):
        """S5 修复: RX 480 应识别为 rx500"""
        self.assertEqual(self.scorer.identify_model("Radeon RX 480", "amd"), "rx500")

    def test_14_amd_rx580(self):
        self.assertEqual(self.scorer.identify_model("Radeon RX 580", "amd"), "rx500")

    # ── AMD 其他 ──
    def test_15_amd_rx9000(self):
        self.assertEqual(self.scorer.identify_model("Radeon RX 9070 XT", "amd"), "rx9000")

    def test_16_amd_rx7000(self):
        self.assertEqual(self.scorer.identify_model("Radeon RX 7900 XTX", "amd"), "rx7000")

    def test_17_amd_rx6000(self):
        self.assertEqual(self.scorer.identify_model("Radeon RX 6800 XT", "amd"), "rx6000")

    def test_18_amd_rx5000(self):
        self.assertEqual(self.scorer.identify_model("Radeon RX 5700 XT", "amd"), "rx5000")

    def test_19_amd_vega(self):
        self.assertEqual(self.scorer.identify_model("Radeon RX Vega 64", "amd"), "vega")

    def test_20_amd_instinct(self):
        self.assertEqual(self.scorer.identify_model("AMD Instinct MI300X", "amd"), "instinct")

    def test_21_amd_unknown(self):
        self.assertEqual(self.scorer.identify_model("AMD SomethingStrange", "amd"), "amd_other")

    # ── Intel ──
    def test_22_intel_arc_bmg(self):
        self.assertEqual(self.scorer.identify_model("Intel Arc B580", "intel"), "arc_bmg")

    def test_23_intel_arc(self):
        self.assertEqual(self.scorer.identify_model("Intel Arc A770", "intel"), "arc")

    def test_24_intel_iris(self):
        self.assertEqual(self.scorer.identify_model("Intel Iris Xe", "intel"), "iris")

    def test_25_intel_unknown(self):
        self.assertEqual(self.scorer.identify_model("Intel Unknown GPU", "intel"), "intel_other")

    # ── Unknown ──
    def test_26_unknown_vendor(self):
        self.assertIsNone(self.scorer.identify_model("Some Totally Unknown GPU", "unknown"))
    ...
    def test_27_model_cache(self):
        ...
        self.assertEqual(self.scorer._model_cache[cache_key], "rtx40")  # type: ignore[attr-defined]
