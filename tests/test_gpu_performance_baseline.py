...
class PerformanceBaseline:
    ...
    def check_regression(self, test_name: str, current_value: float, 
                         metric_name: str, threshold: float = 0.1) -> bool:
        """检查性能回归
...
class TestGPUPerformanceBaseline:
    ...
    def test_memory_allocation_time_baseline(self):
        ...
        # 记录基线
        baseline.record('memory_allocation', {
...
class TestPerformanceRegression:
    ...
    def test_detect_regression(self):
        """测试检测性能回归"""
        # 创建基线
        baseline.record('regression_test', {
            'value': 100.0
        })
