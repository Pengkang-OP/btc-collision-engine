...
class TestDataMonitor(unittest.TestCase):
    ...
    def test_report_keys_generated(self):
        ...
        self.monitor.report_keys_generated(
            device_idx=0,
            count=1000,
            key_range=(0, 1000)
        )
    ...
    def test_detect_duplicate_key(self):
        ...
        duplicate_issues = [
            i for i in issues 
            if i['issue_type'] == DataQualityIssue.DUPLICATE_KEY
        ]
    ...
    def test_detect_invalid_key(self):
        ...
        invalid_issues = [
            i for i in issues 
            if i['issue_type'] == DataQualityIssue.INVALID_KEY
        ]
    ...
    def test_detect_stale_data(self):
        ...
        stale_issues = [
            i for i in issues 
            if i['issue_type'] == DataQualityIssue.STALE_DATA
        ]
    ...
    def test_get_issues_filter(self):
        ...
        # 触发不同类型的问题
        self.monitor.report_match(device_idx=0, match_data={
            'private_key': 'short',
            'address': '1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa',
        })
        
        self.monitor.report_match(device_idx=1, match_data={
            'private_key': 'a' * 64,
            'address': '1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa',
        })
