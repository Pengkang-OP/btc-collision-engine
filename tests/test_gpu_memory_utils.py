...
import pytest
from src.utils.gpu_memory_utils import calculate_optimal_batch_size, MIN_GPU_MEMORY, DEFAULT_BATCH_SIZE, BatchSizeConfig
...
class TestParameterized:
    ...
    @pytest.mark.parametrize("mem_size,expected_range", [
