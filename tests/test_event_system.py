...
class TestCollisionEvent(unittest.TestCase):
    """测试事件数据类"""
    ...
    def test_engine_progress_event(self):
        ...
        self.assertEqual(event.speed, 537000.0)
        self.assertEqual(event.event_type, EventType.ENGINE_PROGRESS)
...
class TestEventBus(unittest.TestCase):
    ...
    def test_subscribe_and_publish(self):
        ...
        self.assertEqual(received_events[0].total_checked, 1000)
    ...
    def test_unsubscribe(self):
        ...
        bus.publish(EngineProgressEvent())
        self.assertEqual(call_count[0], 1)  # 应该仍然为1
    ...
    def test_no_duplicate_subscribers(self):
        ...
        bus.publish(EngineProgressEvent())
        self.assertEqual(call_count[0], 1)  # 只应该调用一次
    ...
    def test_handler_error_callback(self):
        ...
        self.assertEqual(errors[0][0], EventType.ENGINE_PROGRESS)
...
class TestEventBusThreadSafety(unittest.TestCase):
    ...
    def test_concurrent_publish(self):
        ...
        # 应该处理了所有事件
        self.assertEqual(counter[0], 500)
...
class TestDataLoggerAdapter(unittest.TestCase):
    """测试DataLogger事件适配器"""
    ...
    def test_setup_data_logging(self):
        ...
        self.assertEqual(adapter.data_logger, mock_logger)
