...
=======
        """测试Intel配置（v4.2.1: Arc A770 16GB优化为1048576）"""
>>>>>>> Stashed changes
...
=======
        # v4.2.1优化: Arc A770(16GB)使用1048576批次; 低显存设备使用更小批次
...
=======
            config["batch_size"], 1048576, "Intel Arc A770(≥15GB) 应使用1048576批次(v4.2.1优化)"
>>>>>>> Stashed changes
        )
