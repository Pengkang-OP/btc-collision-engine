...
class TestCollisionErrorBase:
    ...
    def test_exception_str_representation(self):
        ...
        str_repr = str(error)
        assert str_repr  in  "[1000]"
        assert str_repr  in  "Test message"
    ...
    def test_exception_to_dict_with_original(self):
        ...
        assert error_dict  in  "original_error"
    ...
    def test_exception_can_be_raised(self):
        ...
        assert context.exception.message  ==  "Raised error"
        assert context.exception.error_code  ==  1000
