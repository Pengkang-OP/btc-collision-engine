...
def compare_results(cpu_result, gpu_result):
    ...
    print("-"*70)
    print(f"{'总检查数':<20} {cpu_result['total_checked']:>15,}  {gpu_result['total_checked']:>15,}" if gpu_result else f"{'总检查数':<20} {cpu_result['total_checked']:>15,}  {'N/A':>20}")
    print(f"{'运行时间(秒)':<18} {cpu_result['elapsed']:>15.2f}  {gpu_result['elapsed']:>15.2f}" if gpu_result else f"{'运行时间(秒)':<18} {cpu_result['elapsed']:>15.2f}  {'N/A':>20}")
    print(f"{'平均速度(keys/s)':<18} {cpu_result['speed']:>15.2f}  {gpu_result['speed']:>15.2f}" if gpu_result else f"{'平均速度(keys/s)':<18} {cpu_result['speed']:>15.2f}  {'N/A':>20}")
