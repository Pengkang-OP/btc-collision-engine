...
class TestGPUEngineInitialization:
    ...
    def test_gpu_engine_init_success(self):
        ...
        with patch('src.collision.gpu_collision_engine.PYOPENCL_AVAILABLE', True):
            ...
            with patch('src.collision.gpu_collision_engine.GPUDeviceDetector.is_gpu_available', return_value=True), \
...
class TestCollisionModes:
    ...
    def _patch_gpu_engine_all(self, mock_device, mock_context, mock_kernel, mock_profile_loader):
        ...
        return [
            ...
            patch('src.collision.gpu_collision_engine.GPUContext', return_value=mock_context),
            patch('src.collision.gpu_collision_engine.GPUKernel', return_value=mock_kernel),
            patch('src.collision.gpu_collision_engine.GPUProfileLoader', return_value=mock_profile_loader),
