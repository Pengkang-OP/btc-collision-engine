...
class TestGPUDeviceScoring(unittest.TestCase):
    ...
    def test_01_score_calculation(self):
        ...
        for device in devices:
            ...
            expected = (device['global_mem_gb'] * 10.0 + device['max_compute_units'] * 0.05) * vendor_factor
    ...
    def test_02_select_best_device(self):
        ...
        devices = [
            {'name': 'NVIDIA RTX 3080', 'vendor': 'nvidia', 'global_mem_gb': 10.0, 'max_compute_units': 68, 'global_index': 0},
            {'name': 'AMD RX 6800 XT', 'vendor': 'amd', 'global_mem_gb': 16.0, 'max_compute_units': 72, 'global_index': 1},
            {'name': 'Intel Arc A770', 'vendor': 'intel', 'global_mem_gb': 16.0, 'max_compute_units': 512, 'global_index': 2},
        ]
...
class TestGPUSelectorAPI(unittest.TestCase):
    ...
    def test_03_select_by_index(self):
        ...
        devices = [
            {'global_index': 0, 'name': 'GPU 0', 'vendor': 'nvidia', 'global_mem_gb': 10.0, 'max_compute_units': 68},
            {'global_index': 1, 'name': 'GPU 1', 'vendor': 'amd', 'global_mem_gb': 16.0, 'max_compute_units': 72},
        ]
