...
class TestBruteForceLimit:
    ...
    def test_brute_force_with_max_keys(self):
        ...
        engine = KeyCollisionEngine(targets=targets, max_workers=2, dedup_enabled=False)
    ...
    def test_brute_force_without_max_keys_warning(self, caplog):
        """测试未设置max_keys时发出警告"""
        targets = {"12ib7dApVFvg82TXKycWBNpN8kFyiAN1dr"}
        engine = KeyCollisionEngine(targets=targets, max_workers=1, dedup_enabled=False)
...
class TestStartupCleanup:
    ...
    def test_engine_cleanup_on_failure(self):
        ...
        engine = KeyCollisionEngine(targets=targets, max_workers=2)
...
class TestBoundaryConditions:
    ...
    def test_range_scan_small_range(self):
        """测试小范围扫描（单线程）"""
        targets = {"12ib7dApVFvg82TXKycWBNpN8kFyiAN1dr"}
        engine = KeyCollisionEngine(targets=targets, max_workers=4, dedup_enabled=False)
