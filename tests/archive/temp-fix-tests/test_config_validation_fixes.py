...
class TestCodeReviewFixes:
    ...
    def test_fix_4_strict_bool_check(self):
        ...
        try:
            ...
            # 验证错误字段
            error_keys = list(errors.keys())
            assert "performance_monitoring.enabled" in error_keys or \
                   "performance_monitoring.track_slow_operations" in error_keys or \
                   "gpu.use_gpu" in error_keys, \
