...
class TestGPUBufferAllocator:
    ...
    def test_allocate_input_delegates(self):
        ctx = object()
        a = GPUBufferAllocator(ctx)
        with patch.object(a._input_pool, "allocate") as ma:
    ...
    def test_allocate_output_delegates(self):
        ctx = object()
        a = GPUBufferAllocator(ctx)
        with patch.object(a._output_pool, "allocate") as ma:
    ...
    def test_allocate_temp_delegates(self):
        ctx = object()
        a = GPUBufferAllocator(ctx)
        with patch.object(a._temp_pool, "allocate") as ma:
            a.allocate_temp(128)
    ...
    def test_release_input_delegates(self):
        ...
        with patch.object(a._input_pool, "release") as mr:
    ...
    def test_release_output_delegates(self):
        ...
        with patch.object(a._output_pool, "release") as mr:
    ...
    def test_release_temp_delegates(self):
        ...
        with patch.object(a._temp_pool, "release") as mr:
