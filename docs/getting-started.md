...
1. [DOC] 阅读 [需求规格](requirements.md)

2. [BUILD] 查看 [架构文档](architecture.md)

3. [SECURE] 学习 [安全指南](security-guidelines.md)

4. [STATS] 查看 [性能优化指南](performance-optimization.md)
