...
>
> 📢 **v3.5.1 Phase 6 重大更新**: GPU 引擎架构重构完成（引擎行数 -73%, 导入模块 -70%）, 29 项专项测试全通过, 测试体系增强, data_logs 归档
> 📢 **v3.5.0更新**: 全模块类型提示系统化工程 (104文件)、配置热重载、多渠道告警系统、70新测试
...
- [RELEASE_NOTES_v3.5.1.md](RELEASE_NOTES_v3.5.1.md) - v3.5.1 Phase 6 发布说明 (🆕)
...
| 日期 | 更新内容 | 版本 |
|------|---------|------|
| 2026-05-01 | v3.5.1 Phase 6：GPU引擎架构重构完成（-73%行数,-70%导入）、测试交叉污染修复、data_logs归档 | v3.5.1 |
| 2026-04-30 | v3.5.0版本发布：P3-3类型提示104文件、P2-4配置热重载、P2-7告警系统、P3-12测试 | v3.5.0 |
| 2026-04-30 | v3.4.0版本发布：Wizard模块化、GPU引擎重构、日志子系统、CLI增强 | v3.4.0 |
