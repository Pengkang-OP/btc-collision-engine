...
| 测试模块 | 测试数 | 覆盖修复 | 状态 |
|---------|-------|---------|------|
| test_multiprocess_security | 30 | A类、B类 | ✅ 通过 |
| test_gpu_memory_pool | 11 | A类 | ✅ 通过 |
| test_gpu_recovery | 20 | A类、B类 | ✅ 通过 |
| test_alert_system | 18 | B类 | ✅ 通过 |
| test_address_import | 7 | C类 | ✅ 通过 |
| test_gpu_device_helper | 59 | B类 | ✅ 通过 |
| **总计** | **145** | **全部** | **✅ 通过** |
