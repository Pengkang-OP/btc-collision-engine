...
|---------|----------|-----------|---------|
| 中等私钥 | 0.0011ms/次 | 0.0188ms/次 | **17.60x** 🔥 |
| 大私钥 | 0.0015ms/次 | 0.0185ms/次 | **11.96x** 🔥 |
| 接近N | 0.0012ms/次 | 0.0172ms/次 | **14.09x** 🔥 |
...
| 大数模逆元 | 回退Python | **14.55x** | 🚀 巨大提升 |
| SIMD哈希 | 回退hashlib | **已启用AES-NI** | ✅ 可用 |
