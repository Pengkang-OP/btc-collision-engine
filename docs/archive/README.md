...
#### alert-system-optimization/ - 告警系统优化
...
1. **按类型查找**: 根据文档类型进入对应目录
2. **按时间查找**: 查看temp-reports-20260422等时间标记目录
3. **按功能查找**: 如GPU相关查看gpu-related/, UI相关查看ui-related/
