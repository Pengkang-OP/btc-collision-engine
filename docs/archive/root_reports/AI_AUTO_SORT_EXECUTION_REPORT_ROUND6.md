...
| **回滚** | **禁用快速数学** | **65,536** ❌ | **43,314** | **-9.6%** |
| **修复** | **batch_size恢复** | **262,144** ✅ | **~47,500** | **+9.6%** |
...
| 指标 | 数值 | 状态 |
|------|------|------|
| 平均速度 | ~47,500 keys/s | ✅ 优秀 |
| batch_size | 262,144 | ✅ 最优 |
| 显存使用 | ~10.5 MB | ✅ 合理 |
| 稳定性 | CV < 1% | ✅ 稳定 |
| 精度 | 完全精度 | ✅ 安全 |
