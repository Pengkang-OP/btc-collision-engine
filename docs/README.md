...
│   ├── audit-reports/               # 技术审计报告
│   └── archive/                     # 归档文档目录（38个历史过程文档）
├── src/                           # 源代码
│   ├── core/                      # 核心算法
│   ├── collision/                 # 碰撞引擎
│   ├── cli/                       # 命令行工具
...
<<<<<<< Updated upstream
*文档生成时间: 2026-05-18*
*最近更新: v4.4.0 (2026-05-18) 安全修复增强，全项目版本统一，文档清理*
=======
*文档生成时间: 2026-04-28*
*最近更新: v4.2.2 (2026-05-15) mod_inverse溢出修复，版本统一*
>>>>>>> Stashed changes
