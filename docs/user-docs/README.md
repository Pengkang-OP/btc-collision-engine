...
- [文档导航](#文档导航)
  ...
  - [[PC] API和界面 (2个)](#-api和界面-2个)

  - [[LOCK] 安全和性能 (3个)](#-安全和性能-3个)

  - [[TOOL] 运维和监控 (3个)](#-运维和监控-3个)
...
- [CHECK] [综合审计报告](comprehensive-audit-report.md) - 15维度全面审计(2026-04-20) *

- [PACKAGE] [归档文档](archive/README.md) - 历史过程文档
...
> [PACKAGE] **注意**: 历史过程文档（异常处理、SecureKeyManager、代码审查等系列）已归档到 [archive](archive/README.md) 目录。
