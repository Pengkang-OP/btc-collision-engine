...
### 2. CFG-2: Intel Arc配置参数统一为保守策略 ✅ (中风险)
...
| 性能风险 | 🟡 中 | CPU-GPU同步瓶颈，需优化 |
| 可用性风险 | 🟢 低 | 优雅停止+断点续传保证可用性 |
| 维护风险 | 🟡 中 | 配置分散、代码复杂度高需优化 |
