...
class CryptoConfig:
    ...
    def apply_to_crypto_manager(self) -> bool:
        ...
        backend_mapping = {
            ...
            CryptoBackendType.PURE_PYTHON_CONST_TIME: (BackendType.PURE_PYTHON, {"use_const_time": True}),
    ...
    def get_gpu_config(self) -> Dict[str, Any]:
        ...
        if self.config_manager:
            return {
                ...
                "enable_vendor_optimizations": self.config_manager.get("gpu.enable_vendor_optimizations", True),
            }
