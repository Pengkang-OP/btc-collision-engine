...
class StatsPerformanceMonitor:
    ...
    def _check_alerts(self, sample: PerformanceSample) -> None:
        ...
        if sample.lock_contention > self._thresholds['lock_contention'] * 100:
            alerts.append(('lock_contention', sample.lock_contention, self._thresholds['lock_contention'] * 100))
    ...
    def get_recent_performance(self, window_seconds: float = 10.0) -> Dict[str, Any]:
        ...
        return {
            ...
            'average_lock_contention': sum(s.lock_contention for s in recent_samples) / len(recent_samples),
