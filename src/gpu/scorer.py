...
class GPUDeviceScorer:
    ...
    def select_best(self, devices: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        """选择评分最高的设备
    ...
    def compare_devices(
        self, device_a: Dict[str, Any], device_b: Dict[str, Any]
    ) -> str:
        """比较两个设备的性能
    ...
    def _get_generation_bonus(
        self, vendor: str, device_name: str, model: str = ''
    ) -> float:
        """根据GPU型号获取世代附加分
...
# 模块级单例
_scorer_instance: Optional[GPUDeviceScorer] = None
