    ...
    def get_optimization_info(self) -> dict:
        ...
        info = {
            'precomputed_table': {
                ...
                'memory_usage_kb': self.precomputed_table.get_memory_usage() / 1024 if self.precomputed_table else 0
            },
            'simd_hash': {
                'enabled': self.use_simd_hash,
                'backend': self.simd_optimizer.get_backend_name() if self.simd_optimizer else 'disabled'
            },
            'memory_pool': {
