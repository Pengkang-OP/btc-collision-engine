...
cases = [
    ...
    (
        "NVIDIA full name",
        {"vendor": "NVIDIA Corporation", "name": "GTX 1660 Ti", "global_mem_size": 6 * 1024**3},
        "NVIDIA",
        True,
        False,
    ),
    (
        "NVIDIA short",
        {"vendor": "nvidia", "name": "RTX 3090", "global_mem_size": 24 * 1024**3},
        "NVIDIA",
        True,
        False,
    ),
    (
        "Intel full name (A770)",
        {
    ...
    (
        "Intel short",
        {"vendor": "intel", "name": "Arc A750", "global_mem_size": 8 * 1024**3},
        "INTEL",
        True,
        True,
    ),
    (
        ...
        {"vendor": "Intel(R) OpenCL", "name": "Intel HD", "global_mem_size": 2 * 1024**3},
        "INTEL",
        True,
        True,
    ),
    ...
    (
        "AMD short",
        {"vendor": "amd", "name": "RX 580", "global_mem_size": 8 * 1024**3},
        "AMD",
        True,
        False,
    ),
    (
        "Unknown vendor",
        {"vendor": "SomeOtherVendor", "name": "Unknown GPU", "global_mem_size": 4 * 1024**3},
        "UNKNOWN",
        False,
        False,
    ),
    (
        "Empty vendor",
        {"vendor": "", "name": "No vendor", "global_mem_size": 4 * 1024**3},
        "UNKNOWN",
        False,
        False,
    ),
