...
class AISortExecutor:
    ...
    def display_task_list(self):
        ...
        for i, task in enumerate(self.tasks, 1):
            ...
            print(f"{priority_level:<6} {task.id:<8} {task.name:<35} {task.priority_score:<8.1f} {task.category:<12}")
...
"""
    ...
    def generate_report(self):
        ...
        # 保存报告
        report_file = self.project_root / f"AI_AUTO_SORT_EXECUTION_REPORT_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
