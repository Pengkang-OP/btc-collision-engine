...
old1d = '                        "# 格式: timestamp,speed,total_checked,matches,cpu_usage,memory_usage,threads\\n"  # noqa: E501'
if old1d in content:
    new1d = '                        "# 格式: timestamp,speed,total_checked,matches,cpu_usage,memory_usage,threads,gpu_temp,gpu_mem,gpu_util\\n"  # noqa: E501'
...
old1e = '            csv_line = f"{timestamp},{speed},{total_checked},{matches_found},{cpu_usage},{memory_usage},{thread_count}\\n"  # noqa: E501'
if old1e in content:
    new1e = (
        "            # P1-2: 包含GPU指标\n"
