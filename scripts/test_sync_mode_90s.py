...
def test_sync_mode(test_duration: int = 90, analysis_duration: int = 60):  # noqa: C901
    """测试同步模式"""
    print("=" * 80)
    print("  同步模式(单缓冲)性能测试")
    print("=" * 80)
    ...
    try:
        ...
        filepath = os.path.join(output_dir, f"sync_mode_{timestamp}.json")
